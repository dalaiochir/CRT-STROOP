  ...
  return (
    <div className="grid2">
      <section className="card">
        <h3 className="h1">Танин мэдэхүй-сэтгэл хөдлөлийн зохицуулалтын асуулга (CERQ), Сонгох хариу үйлдлийн хугацаа болон Stroop өнгөний тест</h3>
      ...
      <aside className="card">
        ...
        <p className="p">
          CERQ тест нь танин мэдэхүйн зохицуулалтыг ашиглах байдлаар сэтгэл хөдлөлөө
